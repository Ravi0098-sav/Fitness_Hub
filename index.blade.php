            ...
            <div class="row px-3 align-items-center">
                <div class="col-md-6">
                    <div class="pr-md-3 d-none d-md-block">
                        ...
                        <p class="m-0 text-white">BMI is a measure of body fat based on height and weight. It's used to categorize individuals into different weight categories and assess potential health risks associated with being underweight, normal weight, overweight, or obese.</p>
                    </div>
                </div>
                    ...
                    <div class="py-5 px-3">
                        ...
                        <form id="bmiForm">
                            <div class="form-row">
                                <div class="col form-group">
                                    <input type="number" step="0.1" id="weight" class="form-control form-control-lg bg-dark text-white" placeholder="Weight (KG)" required>
                                </div>
                                <div class="col form-group">
                                    <input type="number" step="0.1" id="height" class="form-control form-control-lg bg-dark text-white" placeholder="Height (CM)" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col form-group">
                                    <input type="number" id="age" class="form-control form-control-lg bg-dark text-white" placeholder="Age" required>
                                </div>
                                <div class="col form-group">
                                    <select id="gender" class="custom-select custom-select-lg bg-dark text-white" required>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <button type="submit" class="btn btn-lg btn-block btn-dark border-light">
                                        Calculate Now
                                    </button>
                                </div>
                            </div>
                        ...
                        <div id="bmiResult" class="mt-4" style="display: none;">
                            <div class="alert alert-info text-center">
                                ...
                                <button type="button" class="btn btn-light" onclick="resetBMI()">Calculate Again</button>
                            </div>
                        </div>
                    </div>
                </div>
   ...
   <!-- Team Start -->
    ...
    document.getElementById('bmiForm').addEventListener('submit', function(e) {
        ...
        if (bmi < 18.5) {
            ...
            description = 'You may need to gain weight. Consult with a healthcare provider for advice.';
            ...
            category = 'Overweight';
            description = 'You may need to lose some weight. Consider a balanced diet and exercise.';
            bgColor = '#ffc107'; // warning yellow
            textColor = '#000';
        } else {
            category = 'Obese';
            description = 'You should consult with a healthcare provider for a weight management plan.';
