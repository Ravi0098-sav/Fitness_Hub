        ...
        <div class="col-md-6 mb-5">
            <div class="row align-items-center">
                ...
                <div class="col-sm-7">
                    ...
                    <p>Sit lorem ipsum et diam elitr est dolor sed duo...</p>
                </div>
            </div>
        </div>
        ...
        <div class="row px-3 align-items-center">
                    ...
                    <div id="carouselId" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active">
                                <div class="d-flex align-items-center mb-4 text-white">
                                    <img width="80" height="80" class="rounded-circle bg-dark p-2"
                                         src="{{ asset('frontend/img/testimonial-1.jpg') }}" alt="Image">
                                    <div class="pl-4">
                                ...
                                <div class="testimonial-text position-relative border bg-dark text-white mb-5 p-4">
                                    Sed ea amet kasd elitr stet nonumy...
                                </div>
                            </div>
                            ...
                            <div class="carousel-item">
                                <div class="d-flex align-items-center mb-4 text-white">
                                    <img width="80" height="80" class="rounded-circle bg-dark p-2"
                                         src="{{ asset('frontend/img/testimonial-2.jpg') }}" alt="Image">
                                    <div class="pl-4">
                                        <h4 class="text-primary">Client Name</h4>
                                        <p class="m-0">Profession</p>
                                    </div>
                            ...
                            <div class="carousel-item">
                                <div class="d-flex align-items-center mb-4 text-white">
                                    <img width="80" height="80" class="rounded-circle bg-dark p-2"
                                         src="{{ asset('frontend/img/testimonial-3.jpg') }}" alt="Image">
                                    <div class="pl-4">
                                        <h4 class="text-primary">Client Name</h4>
                                        <p class="m-0">Profession</p>
                                    </div>
            ...
            <div class="col-md-6">
                <div class="pl-md-3 d-none d-md-block">
                    ...
                    <p class="m-0 text-white">Vero elitr lorem magna justo...</p>
                </div>
            </div>
        </div>
    </div>
